use crate::quantumclaw_ir::optimization::{
    BinaryVariable, OptimizationConstraint, OptimizationProblem,
};
use crate::quantumclaw_ir::DecisionProblem;
use crate::quantumclaw_optimization::error::{OptimizationError, Result};
...
pub fn action_selection_problem(problem: &DecisionProblem) -> Result<OptimizationProblem> {
    ...
    for action in &problem.candidate_actions {
        ...
        model
            .linear
            .push(crate::quantumclaw_ir::optimization::LinearTerm::new(
                action.id.clone(),
