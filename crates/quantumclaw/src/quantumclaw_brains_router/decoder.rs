...
use crate::quantumclaw_brains_router::models::{DeliveryProblem, Route, RouteSolution};
use crate::quantumclaw_brains_router::network::Network;
use crate::quantumclaw_brains_router::vrp;
use crate::quantumclaw_ir::optimization::OptimizationSolution;
...
pub fn assignments_from_solution(
    ...
    model: &crate::quantumclaw_ir::optimization::OptimizationProblem,
) -> Assignment {
