...
//! domain-neutral [`crate::quantumclaw_ir::optimization::OptimizationProblem`] and
//! hands it to whatever [`crate::quantumclaw_core::SolverBackend`] the registry
//! offers.
//!
...
use crate::quantumclaw_brains::{BrainRegistry, JsonBrain};
use std::sync::Arc;
