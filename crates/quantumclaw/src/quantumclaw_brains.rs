...
//! solved goes through [`crate::quantumclaw_core::SolverBackend`], so a brain never
...
use crate::quantumclaw_core::{AgentTask, QuantumClawError, Result, SolverRegistry};
use crate::quantumclaw_ir::optimization::OptimizationProblem;
