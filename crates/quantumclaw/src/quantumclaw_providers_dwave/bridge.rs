...
use crate::quantumclaw_providers_dwave::models::{
    BridgeRequest, BridgeResponse, BridgeResult, ProbeReport,
};
use crate::quantumclaw_providers_dwave::DWaveConfig;
...
const INSTALL_HINT: &str = "D-Wave Ocean backend is not installed. Install QuantumClaw with D-Wave support: pip install 'quantumclaw-dwave[dwave]'";
